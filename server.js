...
mongoose.connect("mongodb://heroku_zwvvk3vr:5qvrenk0fka1eepj7mi79hsre2@ds155651.mlab.com:55651/heroku_zwvvk3vr");
...
app.get("/scrape", function(req, res) {
  request("https://www.nytimes.com/section/world?WT.nav=page&action=click&contentCollection=World&module=HPMiniNav&pgtype=Homepage&region=TopBar", function(error, response, html) {
    ...
    $(".story-link").each(function(i, element) {
      ...
      result.description = $(this).children().children(".summary").text().trim();
      result.byline = $(this).children().children(".byline").text().trim();
